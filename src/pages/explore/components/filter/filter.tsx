...
import { getDictionary } from '@/components/inputs/button/submit/dictionary';

/// Functions
import { getPathSetState } from '@/functions/functions';
...
import CustomButton from '@/components/inputs/button/custom/button';
