// Import
/// Types / Safeguards
import { isTextInputFieldCOProps, isTextInputFieldProps, isTextInputAreaProps, isTextInputFieldSOProps, isTextInputAreaCOProps, GetValueParams, GetClickNewOpenedParams, OnClickParams, GetPatternValueParams, GetEditValueParams, GetChangeNewValueParams, GetFilterOptionsParams, GetChangeNewOptionsParams, GetChangeNewOpenedParams, GetChangeNewValuesParams, OnChangeParams } from '@/components/inputs/text/text/types';
