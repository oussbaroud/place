...
/// Types / Safeguards
import { LastNameInputProps } from './types';
...
// Component
export default forwardRef< HTMLDivElement, LastNameInputProps >( function LastNameInput( props, ref ) {
    // Dictionary
    const dictionary = getLastNameDictionary( props );
