...
import { onChange, onClick } from './functions';
...
// Components
function Button ( { props }: { props: PasswordInputProps; } ) {
    // Props
    const containerClassName = styles.button;
...
export default forwardRef< HTMLDivElement, PasswordInputProps >( function PasswordInput( props, ref ) {
    // Dictionary
    const dictionary = getPasswordDictionary( props );
    ...
    /// Reveal
    const revealId = inputId + '-reveal-password-checkbox';
            ...
            >
                ...
                >
                    <input
                        ...
                        id={ revealId }
                        type={ 'checkbox' }
                        onChange={ ( event ) => onClick( { props, event, inputType } ) }
                    />
                    <Button
                        props={ props }
                    />
